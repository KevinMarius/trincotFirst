<main class="main-blog">
    <div class="banner">
        ...
        <span>Trincot > <strong>Blog</strong></span>
    </div>
    <div class="body-blog">
        <form method="get">
            <input type="hidden" name="p" value="posts.search">
        ...
        <div class="content-blog">
            <div class="content">
                <?php
                    foreach($postPagination as $post) {                        
                ?>
                    <div class="post">
                ...
                <div class="page-blog">
                    <a href="?p=posts.index&page=<?= $currentPage - 1 ?>" class="<?= ($currentPage === 1) ? "disabled" : "" ?>"><i class="lni-angle-double-left"></i></a>
                    <?php
                        for($page = 1; $page <= $pages; $page++):
                    ?>
                        <a href="?p=posts.index&page=<?= $page ?>" class="<?= ($currentPage == $page) ? "active" : "" ?>"><?= $page ?></a>
                    <?php
                        endfor
                    ?>
                    <a href="?p=posts.index&page=<?= $currentPage + 1 ?>" class="<?= ($currentPage == $pages) ? "disabled" : "" ?>"><i class="lni-angle-double-right"></i></a>
                </div>
            </div>
            <div class="sidebar">
